...
public class Repository extends Entity
{
  ...
  @JsonIgnore
  private Map<String, List<Issue>> concernedIssues = new HashMap<>();
  ...
  public Map<String, List<Issue>> getConcernedIssues()
  {
    return concernedIssues;
  }

  public void setConcernedIssues(Map<String, List<Issue>> concernedIssues)
  {
    this.concernedIssues = concernedIssues;
  }

  @Override
  public String toString() {
    return String.format("Entities.Repository: id:%d, "
                         + "name:%s "
                         + "git_url:%s "
                         + "language:%s "
                         + "labels:%s"
